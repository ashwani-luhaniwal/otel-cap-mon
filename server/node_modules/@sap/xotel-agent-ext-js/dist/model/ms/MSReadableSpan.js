...
class MSReadableSpan {
    constructor(span, resource) {
        ...
        this.kind = span.kind;
        switch (span.name) {
            case constants.UseCase.MOCKRECEIVER:
                this.name = 'mock receiver';
                break;
            case constants.UseCase.MOCKSPANRECEIVER:
                this.name = 'mock span receiver';
                break;
        }
...
exports.MSReadableSpan = MSReadableSpan;
